<div class="modal fade" id="modal-add" tabindex="-1" data-bs-backdrop="true">
...
<div class="row g-3">
<div class="col-md-12">
<input type="text" class="form-control" name="pekerjaan" id="pekerjaan" placeholder="Nama pekerjaan">
...
<script>
    $('#form-pekerjaan').submit(function (e) { 
        ...
        $.ajax({
            type: "post",
            url: "<?=base_url('admin/pekerjaan/save')?>",
            data: $(this).serialize(),
            dataType: "json",
            beforeSend: function() {
